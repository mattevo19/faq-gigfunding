module.exports = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "There could be some instances of this, but only a small percentage. The overall positive impact of the deed is the key aspect and fees won’t be undercutting market rates.<br></br>We think that more skills will be hired because of the fundraising element, creating requests that would otherwise not have been hired at all<br></br>Eg. Sarah wants her wall repainted, but can’t justify spending £100 to do it. However, now she knows about Gigfunding, she can feel content in spending the money, as she knows all the money is going to local causes she loves. The painter might only offer the job as a one off, for the year, but Sarah could hire them again, or recommend them to a friend external to Gigfunding, giving the painter a new paying client.<br></br>We also feel many of the gigs will be tasks that would have normally been favours; eg. Watering your neighbor's plants, doing that job for a mate or walking your friend’s dog.",
        open: false
      },
      {
